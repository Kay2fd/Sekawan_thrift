...
class ClientController extends Controller
{
    ...
    public function AddProductToCart(Request $request)
    {
        ...
        return redirect()->route('addtocart')->with('message', 'Your item successfully added to cart');
    }
    public function RemoveCartItem($id)
    {
        Cart::findOrFail($id)->delete();
        return redirect()->route('addtocart')->with('message', 'Your item removed from cart');
    }
